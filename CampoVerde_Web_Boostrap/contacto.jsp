...
<html lang="es">
    ...
    <body>
        ...
        <!-- Header Start -->
        <div class="container-fluid page-header" style="background-image: url('img/contacto1.jpg'); background-size: cover; background-position: center;">
            <div class="container">
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px;">
                    <h3 class="display-4 text-primary text-uppercase">Contacto</h3>
        ...
        <div class="main-content">
            ...
            <div class="container" style="max-width: 500px; margin: 0 auto;">
                <form>
                    <input class="text-input" type="text" placeholder="Nombres" /><br />
                    <input class="text-input" type="text" placeholder="Teléfono" /><br />
                    <input class="text-input" type="text" placeholder="Email" /><br />
                    <input class="text-input" type="text" placeholder="Empresa" /><br />
                    <input class="text-input" type="text" placeholder="Productos" /><br />
                    <input class="text-input" type="text" placeholder="Ciudad" /><br />
